            ...
            <div className="row justify-content-center">
                <div className="col-lg-8">
                    <div className="section_title text-center mb-80">
                        ...
                        <h3 className="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s" style={{color: "red",opacity:"0.3",zIndex:"22px"}}>About Program</h3>
                        ...
                        <p className="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".4s" style={{opacity:"0.5"}} >This event occurs at the mid of May every year. It is a stage of bringing out the talents of our students. We bring delight, fun and energy.</p>
                    </div>
                </div>
            </div>
            <div className="row align-items-center">
                <div className="col-lg-7 col-md-6">
                    <div className="about_thumb">
                        ...
                        <div className="thumb_inner  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                            <img src="img/about/about.jpg" alt=""></img>
                        </div>
                    </div>
                </div>
                <div className="col-lg-5 col-md-6">
                    <div className="about_info pl-68">
                        ...
                        <p className=" wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".6s">ENTHUZEA happens every mid summer.This event offers its audience with energy, entairtainment and joy. It is something evenryone waits for.</p>
